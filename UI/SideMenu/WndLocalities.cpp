...
Join %14 on %15.IdCounty = %16.Id")
            .arg(DBWrapper::Locality::STR_TABLE_NAME)
            .arg(DBWrapper::Comune::STR_TABLE_NAME).arg(DBWrapper::Comune::STR_TABLE_NAME).arg(DBWrapper::Comune::STR_TABLE_NAME).arg(DBWrapper::Comune::STR_TABLE_NAME)
            .arg(DBWrapper::County::STR_TABLE_NAME).arg(DBWrapper::County::STR_TABLE_NAME).arg(DBWrapper::County::STR_TABLE_NAME).arg(DBWrapper::County::STR_TABLE_NAME)
            .arg(DBWrapper::Locality::STR_TABLE_NAME).arg(DBWrapper::Comune::STR_TABLE_NAME).arg(DBWrapper::Locality::STR_TABLE_NAME).arg(DBWrapper::Comune::STR_TABLE_NAME)
            .arg(DBWrapper::County::STR_TABLE_NAME).arg(DBWrapper::Comune::STR_TABLE_NAME).arg(DBWrapper::County::STR_TABLE_NAME);
